  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] px-6 md:px-12 py-10">
      ...
      <div className="mb-10 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-2 bg-[#eff6ff] text-[#2563eb] px-4 py-2 rounded-full text-sm font-semibold shadow-sm">
          {messages.length} Messages
        </div>
      </div>

      {/* ===== FORM ===== */}
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-10 rounded-3xl shadow-lg border border-gray-100 mb-12">
        ...
        >
          <input
            ...
            onChange={handleChange}
            placeholder="Your Name"
            className="border border-gray-200 px-4 py-3 rounded-xl focus:ring-2 focus:ring-[#2563eb] focus:border-[#2563eb] outline-none transition"
            required
          />
          ...
          <input
            ...
            onChange={handleChange}
            placeholder="Subject"
            className="border border-gray-200 px-4 py-3 rounded-xl md:col-span-2 focus:ring-2 focus:ring-[#2563eb] outline-none transition"
            required
          />
          ...
          <textarea
            ...
            rows="5"
            placeholder="Your Message"
            className="border border-gray-200 px-4 py-3 rounded-xl md:col-span-2 focus:ring-2 focus:ring-[#2563eb] outline-none resize-none transition"
            required
          />

          <button
            type="submit"
            className="md:col-span-2 bg-[#2563eb] hover:bg-[#1d4ed8] text-white py-3 rounded-xl font-medium shadow-md hover:shadow-lg transition-all duration-300"
          >
            Send Message
          </button>
        </form>
      ...
      {/* ===== MESSAGES ===== */}
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-semibold text-[#0f172a] mb-6">
          My Messages
        </h1>

        {messages.length === 0 ? (
          <p className="text-gray-400 text-center py-10 bg-white rounded-2xl shadow border">
            No messages found
          </p>
        ) : (
                ...
                {editId === msg._id ? (
                  <>
                    <input
                      ...
                      className="border border-gray-200 px-4 py-3 rounded-xl w-full mb-3 focus:ring-2 focus:ring-[#2563eb] outline-none"
                    />
                    ...
                    <textarea
                      ...
                      className="border border-gray-200 px-4 py-3 rounded-xl w-full focus:ring-2 focus:ring-[#2563eb] outline-none"
                      rows="4"
                    />
                    ...
                    <div className="flex gap-3 mt-4">
                      <button
                        onClick={() => handleUpdate(msg._id)}
                        className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-xl shadow-sm transition"
                      >
                        Save
                      </button>
                      ...
                      <button
                        onClick={() => setEditId(null)}
                        className="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded-xl shadow-sm transition"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <div className="flex gap-3 mt-5">
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[#eff6ff] text-[#2563eb] border border-[#dbeafe] hover:bg-[#dbeafe] transition-all duration-200 text-sm font-medium"
                      >
                        Edit Message
                      </button>
                      ...
                      <button
                        onClick={() => handleDelete(msg._id)}
                        className="flex items-center gap-2 px-4 py-2 rounded-xl bg-red-50 text-red-600 border border-red-200 hover:bg-red-100 transition-all duration-200 text-sm font-medium"
                      >
                        Delete Message
                      </button>
                    </div>
